...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1085341581ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dio_mqsql_projeto&table=movies_series">`dio_mqsql_projeto`.`movies_series`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dio_mqsql_projeto&table=filmes_series">`dio_mqsql_projeto`.`filmes_series`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dio_consultas_com_join&table=videos_channels">`dio_consultas_com_join`.`videos_channels`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dio_consultas_com_join&table=videos">`dio_consultas_com_join`.`videos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dio_consultas_com_join&table=channels">`dio_consultas_com_join`.`channels`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dio_mysql1_server&table=videos">`dio_mysql1_server`.`videos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dio_mysql1_server&table=author">`dio_mysql1_server`.`author`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dio_mysql1_server&table=videos_playlist">`dio_mysql1_server`.`videos_playlist`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dio_mysql1_server&table=playlist">`dio_mysql1_server`.`playlist`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dio_mysql1_server&table=seo">`dio_mysql1_server`.`seo`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="294e3e35425b6f575b51227c6e665575">
...
<div id="topmenucontainer" class="menucontainer">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="dio_consultas_com_join" targettable="videos">
            ...
            Database
                            : <span>dio_consultas_com_join</span>
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT videos.name, videos.created, videos.vid_author, channels.name FROM videos_channels JOIN videos ON videos_channels.fk_videos = videos.id_video
JOIN channels ON videos_channels.fk_channels = channels.id_channel;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dio_consultas_com_join" targettable="videos">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT videos.name AS video_name, videos.created, videos.vid_author, channels.name AS channel_name FROM videos_channels JOIN videos ON videos_channels.fk_videos = videos.id_video
JOIN channels ON videos_channels.fk_channels = channels.id_channel;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dio_consultas_com_join" targettable="videos">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `videos`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dio_consultas_com_join" targettable="videos_channels">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `videos_channels`</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `videos_channels` (`id`, `fk_videos`, `fk_channels`) VALUES (NULL, &#039;12&#039;, &#039;1&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dio_consultas_com_join" targettable="videos_channels">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT videos.name, videos.created, videos.vid_author, channels.name FROM videos_channels JOIN videos ON videos_channels.fk_videos = videos.id_video
JOIN channels ON videos_channels.fk_channels = channels.id_channel WHERE channels.name HAVING &#039;forest&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dio_consultas_com_join" targettable="videos_channels">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT videos.name, videos.created, videos.vid_author, channels.name FROM videos_channels JOIN videos ON videos_channels.fk_videos = videos.id_video
JOIN channels ON videos_channels.fk_channels = channels.id_channel WHERE channels.name= &#039;forest&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dio_consultas_com_join" targettable="videos_channels">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT videos.name, videos.created, videos.vid_author, channels.name FROM videos_channels JOIN videos ON videos_channels.fk_videos = videos.id_video
JOIN channels ON videos_channels.fk_channels = channels.id_channel WHERE channels.name = &#039;forest life&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="dio_mqsql_projeto" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE filmes_series (
    ...
    PRIMARY KEY(id)
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="dio_mqsql_projeto" targettable="filmes_series">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `filmes_series`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="dio_mqsql_projeto" targettable="filmes_series">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE filmes_series CHANGE last_viewed last_viewed DATE DEFAULT CURRENT_TIMESTAMP;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="dio_mqsql_projeto" targettable="filmes_series">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE filmes_series ADD rating INT;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dio_mqsql_projeto" targettable="filmes_series">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO filmes_series (`name`,`type`,`total_epis`,`current_epi`,`last_viewed`,`rating`)
VALUES (&#039;The Office&#039;, 1, 201, 56, &#039;2022-01-30&#039;, 5);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="dio_mqsql_projeto" targettable="filmes_series">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO filmes_series (`name`,`type`,`last_viewed`)
VALUES (&#039;Good Will Hunting&#039;, 0, &#039;2021-06-24&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dio_mqsql_projeto" targettable="filmes_series">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO filmes_series (`name`,`type`,`total_epis`,`current_epi`,`last_viewed`,`rating`)
VALUES (&#039;The Leftovers&#039;, 1, 46, 20, &#039;2018-02-17&#039;, 1);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dio_mqsql_projeto" targettable="filmes_series">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO filmes_series (`name`,`type`,`last_viewed`,`rating`)
VALUES (&#039;Us&#039;, 0,&#039;2019-10-29&#039;, 2);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dio_mqsql_projeto" targettable="filmes_series">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">RENAME TABLE filmes_series TO movies_series;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dio_mqsql_projeto" targettable="movies_series">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `movies_series`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dio_mqsql_projeto" targettable="movies_series">
                            <div class="action_content">
